<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/jinpin' }">精品推荐</el-breadcrumb-item>
          ...
          <ul>
            ...
            <li>
              <select v-model="price" class="inp">
                ...
                <option value="价格:268">{{item.title4}}</option>
                <option value="价格:398">{{item.title5}}</option>
                <option value="价格:475">{{item.title6}}</option>
              </select>
            </li>
            <li style="color:#561801;">
              <span>{{price}}</span>
            </li>
            <!-- <li style="color:#561801;line-height:50px">
              价格:
              <span>¥{{item.price}}元</span>
            </li>-->
            <!-- <li>
              <span class="inp">{{item.title3}}</span>
              <span class="inp">{{item.title4}}</span>
            </li>
            <li>
              <span class="inp">{{item.title5}}</span>
              <span class="inp">{{item.title6}}</span>
            </li>-->
            <el-input-number
              v-model="num"
