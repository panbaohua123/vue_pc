<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>全部蛋糕</el-breadcrumb-item>
    </el-breadcrumb>
    <!--实线 -->
    <div class="line"></div>
    <!-- 图片 -->
      ...
      <div class="box1" @click="to(i+1)">
        <ul>
          ...
          <li class="btn">
            ...
            <el-button type="info" @click="addcart(item.id,item.img,item.title,item.price)">加入购物车</el-button>
          </li>
        </ul>
      </div>
      <!--实线 -->
...
export default {
  ...
  methods: {
    ...
    loadMore() {
      ...
      var url = "dangao";
      //发送请求
      this.axios.get("dangao").then(res => {
        this.list = res.data;
        window.onscroll();
      });
    }
